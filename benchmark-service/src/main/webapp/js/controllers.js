...
(function () {
    ...
    angular.module('benchmarkServiceUI.controllers', ['benchmarkServiceUI.services', 'nvd3'])
        ...
        .controller('BenchmarkCtrl', ['$scope', '$routeParams', '$location', 'BenchmarkService',
                                      'CartCompareService', function ($scope, $routeParams, $location, BenchmarkService, CartCompareService) {
